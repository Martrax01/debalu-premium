    ...
    <footer className="bg-gray-50 py-16 text-center border-t border-gray-100 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-center gap-6 mb-8">
          <a href="https://www.facebook.com/debalu.gelatorrer" className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm border text-gray-500 hover:text-[#1877F2]"><Facebook size={20} /></a>
